...
import { ShoppingBag, Building2, Stethoscope, Megaphone, ArrowRight, CheckCircle2, TrendingUp } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {solutions.map((item, i) => {
          ...
          return (
            <div
              key={i}
              className="rounded-3xl bg-white border border-slate-200/80 p-8 sm:p-10 space-y-6 flex flex-col justify-between shadow-xs hover:border-indigo-400 transition-colors"
            >
